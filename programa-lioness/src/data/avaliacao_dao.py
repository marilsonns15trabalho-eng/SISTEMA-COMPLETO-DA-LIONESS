...
class AvaliacaoDAO:
    ...
    def criar_avaliacao(self, avaliacao: AvaliacaoFisica) -> Optional[int]:
        """
        ...
        Returns:
            ID da avaliação criada ou None se erro
        """
        try:
            query = '''
            ...
            params = (
                ...
                avaliacao.imc,
                avaliacao.relacao_cintura_quadril,
    ...
    def buscar_avaliacao_por_id(self, avaliacao_id: int) -> Optional[AvaliacaoFisica]:
        ...
        try:
            ...
            print(f"Erro ao buscar avaliação por ID: {str(e)}")
            return None
    ...
    def buscar_avaliacoes_por_aluno(self, aluno_id: int) -> List[AvaliacaoFisica]:
        ...
        try:
            ...
            print(f"Erro ao buscar avaliações por aluno: {str(e)}")
            return []
    ...
    def buscar_avaliacao_mais_recente(self, aluno_id: int) -> Optional[AvaliacaoFisica]:
        ...
        try:
            ...
            print(f"Erro ao buscar avaliação mais recente: {str(e)}")
            return None
    ...
    def obter_evolucao_peso(self, aluno_id: int) -> List[dict]:
        ...
        try:
            ...
            print(f"Erro ao obter evolução do peso: {str(e)}")
            return []
    ...
    def obter_evolucao_imc(self, aluno_id: int) -> List[dict]:
        ...
        try:
            ...
            print(f"Erro ao obter evolução do IMC: {str(e)}")
            return []
    ...
    def obter_evolucao_gordura(self, aluno_id: int) -> List[dict]:
        ...
        try:
            ...
            print(f"Erro ao obter evolução do percentual de gordura: {str(e)}")
            return []
    ...
    def contar_avaliacoes(self) -> int:
        ...
        try:
            ...
            print(f"Erro ao contar avaliações: {str(e)}")
            return 0
    ...
    def _row_to_avaliacao(self, row) -> AvaliacaoFisica:
        ...
        """
        # Tratar altura: se for > 10, assume que está em cm e converte para metros
        altura_raw = row['altura']
        if altura_raw and altura_raw > 10:
            altura = altura_raw / 100
        else:
            altura = altura_raw
        ...
        avaliacao.id = row['id']
        if row['data_criacao']:
            avaliacao.data_criacao = datetime.fromisoformat(row['data_criacao'])
